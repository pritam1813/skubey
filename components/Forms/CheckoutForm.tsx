...
const CheckoutForm = ({ addresses }: { addresses: CheckoutAddressData[] }) => {
  ...
  return (
    <form action={formAction}>
      <CartAccordions title="Order Details" step={1}>
        <div className="radio">
      ...
      <CartAccordions title="Payment Method" step={2}>
      ...
      <CartAccordions title="Order Review" step={3}>
        <OrderReviewTable />
