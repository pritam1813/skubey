...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "tw-z-50 tw-min-w-[8rem] tw-overflow-hidden tw-rounded-md tw-border tw-border-neutral-200 tw-bg-white tw-p-1 tw-text-neutral-950 tw-shadow-md dark:tw-border-neutral-800 dark:tw-bg-neutral-950 dark:tw-text-neutral-50",
