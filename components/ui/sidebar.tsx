...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "tw-relative tw-flex tw-min-h-svh tw-flex-1 tw-flex-col tw-bg-white dark:tw-bg-neutral-950",
...
>(({ className, ...props }, ref) => {
  return (
    <Input
      ...
      data-sidebar="input"
      className={cn(
        "tw-h-8 tw-w-full tw-bg-white tw-shadow-none focus-visible:tw-ring-2 focus-visible:tw-ring-sidebar-ring dark:tw-bg-neutral-950",
        className
      )}
      {...props}
    />
