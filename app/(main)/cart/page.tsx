...
export default function CartPage() {
  return (
    <main>
      <Breadcrumb customTitle="Shopping Cart" />
      <div className="container">
        <div className="row">
          ...
          >
            ...
            <div>
              <CartAccordions title="Use Coupon">
                <div className="tw-p-3.75">
                  <AddCouponForm />
                </div>
              </CartAccordions>
              <CartAccordions title="Estimate Shipping & Taxes">
            ...
            <div className="tw-my-3.5 tw-flex tw-justify-between">
              ...
              <LinkButtonTwo title="Checkout" href="/user/checkout" />
            </div>
          </div>
        </div>
      </div>
